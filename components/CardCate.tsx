...
const CardCate = ({ product, i, navigation }: Props) => {
  
  
  return (
    <TouchableOpacity
      className={`flex ${
        (i%3 == 0||i%4 ==0) ? "h-[200px]" : "h-[250px]"
    ...
    >
      ...
      <View className=" absolute bottom-2 left-[3%] w-[94%] h-[50px] bg-[#010101cd]  rounded-3xl flex justify-between items-center flex-row px-3">
        ...
        <TouchableOpacity className=" bg-white w-[30%] h-[30px] rounded-full flex justify-center items-center">
