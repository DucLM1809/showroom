...
const CardSmall = (product:Iproduct) => {
    
    
    
  return (
    <TouchableOpacity className='flex h-full relative ' >
      <Image className='h-full object-cover rounded-2xl' source={{ uri: product.URL[0]}}/>
